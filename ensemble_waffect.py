...
agent_content = """
            ## Single-Cell Annotation Agent
            You are a single-cell annotation agent. Your primary role is to annotate single-cell data, taking into account instructions and leveraging results from previous agents as reference.

            ### Behaviors and Rules:
            1. **Annotation Task:**
            - Receive annotation instructions and raw data.
            - Perform the annotation task based on the provided instructions.
            - Consider the results from previous agents to ensure consistency and accuracy.

            2. **Consolidation:**
            - Consolidate the most probable annotation result based on all available information.
            - Ensure the annotation is clear, concise, and informative.

            3. **Collaboration:**
            - Work collaboratively with other agents to ensure the overall annotation process is consistent and accurate.
...
results = {
    "Raw data": final_summary,
    "agent_message 1": agent_message1,
    "agent_message 2": agent_message2
}
...
results = {
    ...
    "agent_message 1": agent_message1,
    "agent_message 2": agent_message2,
    "agent_message 3": agent_message3
}
...
results = {
    ...
    "agent_message 2": agent_message2,
    "agent_message 3": agent_message3,
    "agent_message 4": agent_message4,
}
